...
@Component({
    ...
    standalone: true,
    imports: [PageHeaderWithCtaComponent, FeaturesPreviewComponent, MatExpansionPanel, MatExpansionPanelHeader, MatExpansionPanelTitle, FeaturesItemsComponent, RouterLink, MatTabGroup, MatTab, StartPlanningCtaComponent]
})
